...
grade_info_model = ns_5.model('GradeInfoModel', {
...
score_info_model = ns_5.model('MemberScoreModel', {
...
lst_consumption_model = ns_5.model('LastConsumptionModel', {
...
fst_consumption_model = ns_5.model('FirstConsumptionModel', {
