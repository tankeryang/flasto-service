...
member_info_model = ns_5.model('MemberInfoModel', {
    'member_birthday': fields.List(fields.Nested(member_birthday, description="会员生日")),
    ...
    'member_manage_store': fields.String(description="会员管理门店", example='1102'),
...
coupon_amount = ns_5.model('CouponAmountConditionModel', {
    ...
    'bt': fields.List(fields.Integer(description="大于", min=0), example=[0, 10]),
})
...
coupon_discount = ns_5.model('CouponDiscountConditionModel', {
    ...
    'bt': fields.List(fields.Float(description="大于"), example=[0.0, 1.0])
})
...
coupon_denomination = ns_5.model('CouponDenominationConditionModel', {
    ...
    'bt': fields.List(fields.Float(description="大于"), example=[0.0, 200.0])
})
...
lst_consumption_gap = ns_5.model('LastConsumptionGapConditionModel', {
    'lt': fields.Integer(description="小于", example=50),
    'gt': fields.Integer(description="大于", example=50),
    'eq': fields.Integer(description="等于", example=50),
    'bt': fields.List(fields.Date(description="介于"), example=[0, 50]),
})
