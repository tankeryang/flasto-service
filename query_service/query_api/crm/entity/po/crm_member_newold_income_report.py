...
crm_member_newold_income_report_model = ns_1.model('CrmMemberNewOldIncomeReportModel', {
...
crm_member_newold_income_report_list_model = ns_1.model('CrmMemberNewOldIncomeReportListModel', {
