...
crm_member_newold_income_report_model = ns.model('CrmMemberNewOldIncomeModel', {
...
crm_member_newold_income_report_list_model = ns.model('CrmMemberNewOldIncomeReportListModel', {
