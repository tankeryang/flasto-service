...
crm_total_income_report_model = ns_1.model('CrmMemberTotalIncomeReportModel', {
...
crm_total_income_report_list_model = ns_1.model('CrmMemberTotalIncomeReportListModel', {
