...
crm_member_level_income_report_model = ns_2.model('CrmMemberLevelIncomeReportModel', {
...
crm_member_level_income_report_list_model = ns_2.model('CrmMemberLevelIncomeReportListModel', {
