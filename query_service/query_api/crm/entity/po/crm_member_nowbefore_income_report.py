...
crm_member_nowbefore_income_report_model = ns.model('CrmMemberNowBeforeIncomeModel', {
...
crm_member_nowbefroe_income_report_list_model = ns.model('CrmMemberNowBeforeIncomeReportListModel', {
