...
crm_member_muldim_income_report_model = ns_2.model('CrmMemberMulDimIncomeReportModel', {
...
crm_member_muldim_income_report_list_model = ns_2.model('CrmMemberMulDimIncomeReportListModel', {
