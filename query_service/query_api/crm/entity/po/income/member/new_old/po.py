...
ALL = ns_2.model('MemberNewOldIncomeReportModel', {
...
ALL_LIST = ns_2.model('MemberNewOldIncomeReportListModel', {
...
DAILY = ns_2.model('MemberNewOldDailyIncomeDetailModel', {
    'brand': fields.String(readOnly=True, description="品牌名"),
    'zone': fields.String(readOnly=True, description="查询范围"),
    'member_type': fields.String(readOnly=True, description="会员类型"),
    'sales_income': fields.Float(readOnly=True, description="销售收入(元)"),
...
DAILY_LIST = ns_2.model('MemberNewOldDailyIncomeDetailListModel', {
...
MONTHLY = ns_2.model('MemberNewOldMonthlyIncomeDetailModel', {
    'brand': fields.String(readOnly=True, description="品牌名"),
    'zone': fields.String(readOnly=True, description="查询范围"),
    'member_type': fields.String(readOnly=True, description="会员类型"),
    'sales_income': fields.Float(readOnly=True, description="销售收入(元)"),
...
MONTHLY_LIST = ns_2.model('MemberNewOldMonthlyIncomeDetailListModel', {
