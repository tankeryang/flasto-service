...
ALL = ns_2.model('MemberLevelIncomeReportModel', {
...
DAILY_LIST = ns_2.model('MemberLevelDailyIncomeDetailListModel', {
...
MONTHLY = ns_2.model('MemberLevelMonthlyIncomeDetailModel', {
    'brand': fields.String(readOnly=True, description="品牌名"),
    'zone': fields.String(readOnly=True, description="查询范围"),
    'member_type': fields.String(readOnly=True, description="会员类型"),
    'sales_income': fields.Float(readOnly=True, description="销售收入(元)"),
...
MONTHLY_LIST = ns_2.model('MemberLevelMonthlyIncomeDetailListModel', {
