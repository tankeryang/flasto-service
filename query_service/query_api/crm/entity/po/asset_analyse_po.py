...
recruit_amount_list_po = ns_3.model('RecruitAmountReportListModel', {
...
recruit_amount_daily_list_po = ns_3.model('RecruitAmountDailyDetailListModel', {
...
recruit_amount_monthly_list_po = ns_3.model('RecruitAmountMonthlyDetailListModel', {
...
recruit_consumed_amount_monthly_po = ns_3.model('RecruitConsumedAmountMonthlyDetailModel', {
    'brand': fields.String(readOnly=True, description="品牌名"),
    'zone': fields.List(fields.String(readOnly=True, description="查询范围")),
    'member_recruit_type': fields.String(readOnly=True, description="招募会员类型"),
    'member_amount': fields.Integer(readOnly=True, description="会员数"),
...
recruit_consumed_amount_monthly_list_po = ns_3.model('RecruitConsumedAmountMonthlyDetailListModel', {
...
recruit_unconsumed_amount_daily_list_po = ns_3.model('RecruitUnconsumedAmountDailyDetailListModel', {
...
recruit_unconsumed_amount_monthly_po = ns_3.model('RecruitUnconsumedAmountMonthlyDetailModel', {
    'brand': fields.String(readOnly=True, description="品牌名"),
    'zone': fields.List(fields.String(readOnly=True, description="查询范围")),
    'member_register_type': fields.String(readOnly=True, description="会员注册类型"),
    'member_amount': fields.Integer(readOnly=True, description="会员数"),
...
recruit_unconsumed_amount_monthly_list_po = ns_3.model('RecruitUnconsumedAmountMonthlyDetailListModel', {
