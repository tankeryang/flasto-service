SQL_CRM_MEMBER_LEVEL_INCOME_REPORT_DATA = """
    ...
    SELECT DISTINCT
        ...
        cast(COALESCE(TRY(SUM(t1.si) * 10000.0 / SUM(t1.oa)), 0) AS DECIMAL(10, 2)) sales_income_per_order,
        cast(COALESCE(TRY(SUM(t1.si) * 10000.0 / SUM(t1.siq)), 0) AS DECIMAL(10, 2)) sales_income_per_item,
        cast(COALESCE(TRY(SUM(t1.siq) * 1.0 / SUM(t1.oa)), 0) AS DECIMAL(10, 2)) sales_item_per_order,
    ...
    UNION SELECT DISTINCT
        ...
        cast(COALESCE(TRY(SUM(t2.si) * 10000.0 / SUM(t2.oa)), 0) AS DECIMAL(10, 2)) sales_income_per_order,
        cast(COALESCE(TRY(SUM(t2.si) * 10000.0 / SUM(t2.siq)), 0) AS DECIMAL(10, 2)) sales_income_per_item,
        cast(COALESCE(TRY(SUM(t2.siq) * 1.0 / SUM(t2.oa)), 0) AS DECIMAL(10, 2)) sales_item_per_order,
        cast(COALESCE(TRY(SUM(t2.si - t2.lyst_si) * 100.0 / SUM(t2.lyst_si)), 0) AS DECIMAL(10, 2)) sales_income_growth
