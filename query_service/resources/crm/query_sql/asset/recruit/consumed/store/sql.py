DAILY = """
     WITH l AS (
         SELECT DISTINCT a.brand_name AS brand, array_distinct(array_agg(a.store_code)) AS zone, a.member_recruit_type, b.date
         FROM (
         ...
         GROUP BY a.brand_name, a.store_code, a.member_recruit_type, b.date
    ), tt AS (
        SELECT brand_name,
    ...
    l.date
    FROM l LEFT JOIN d ON l.brand = d.brand AND l.member_recruit_type = d.member_recruit_type AND l.date = d.date
"""
