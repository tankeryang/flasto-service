SQL_CRM_MEMBER_NOWBEFORE_INCOME_REPORT_DATA = """
    ...
    SELECT DISTINCT matl.member_type AS member_type,
        cast(COALESCE(sm.si, 0) AS DECIMAL(10, 3)) AS sales_income,
        cast(COALESCE(TRY(sm.si * 100.0 / smtt.ttsi), 0) AS DECIMAL(10, 2)) AS sales_income_proportion,
    ...
    SELECT DISTINCT
        ...
        cast(COALESCE(TRY(sm2.si * 100.0 / smtt2.ttsi), 0) AS DECIMAL(10, 2)) AS sales_income_proportion,
